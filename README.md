...
- **自訂劇本封面可用短影片**: 上傳自訂劇本時，第一個檔案除了照片，現在也可以放一段短影片
  ...
  最多 30 個檔案（照片＋影片）。
- **AI 溫柔提醒**: 「已經幾天沒有親密了」卡片新增一顆「請 AI 溫柔提醒另一半」快捷按鈕。
  按下後 AI 諮商師會把「距離上次幾天」用中性、不帶壓力的方式寫成三句可挑選的提醒
  （例如「X 天沒親密囉～找個時間靠近一下吧 🙂」），挑一句就會送到另一半的邀請紀錄，
  也會寄一封貼心提醒信。想換句話可以「換一批」；同一個天數的建議會快取起來，不會重複
  消耗每日 AI 額度。
