...
// remember. Anything longer is a paragraph of intent, not an action. 50 leaves
// room for a natural context-specific sentence (「即使很生氣，也不在孩子面前
//責罵你」) — the earlier 30 was so tight that real model output routinely
// overshot it and got dropped, leaving 幫我想一個 with nothing to show.
const MAX_ASSIST_OPTION_CHARS = 50;
