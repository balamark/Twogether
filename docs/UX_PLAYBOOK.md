...
*建立：2026-07-07；同日完成 §6 決策。§4 R1 摘要已合併進 CLAUDE.md。
下一步：依 P0-1 → P0-2 → P0-3 → P0-4 → P1 順序逐項實作，完成即在 §3 標記。*
